...
<script type="text/javascript" src="${ctx}/js/serve.state.js"></script>
<script type="text/javascript" src="${ctx}/js/customer_serve_feed_back.js"></script>
</head>
<body>
    ...
    <thead>   
        <tr>
            ...
            <th field='overview'>概要</th>
            <th field='state'  id='state' formatter='formatterServeState'>服务状态</th>
