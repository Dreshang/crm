...
<body>
	<table id="dg" class="easyui-datagrid"  pagination=true 
	     rownumbers=true    toolbar="#tb" fit=true url="${ctx}/role/queryRolesByParams">   
    <thead>   
        <tr>
            <th field='cb' id='cb' checkbox=true >id</th>  
            <th field='id' >编号</th>      
...
<div id='dlg' class="easyui-dialog"  style="width: 500px;height: 400px"  closed=true buttons="#bt">
     <form  id="fm" method="post">
     <br/>
	     角色名称:<input name="roleName" type="text"/><br/><br/>
